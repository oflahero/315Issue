namespace _315Issue.Assets
{
    ...
    public class DialogFactory : IDialogFactory
    {
        ...
        public T CreateNamed<T>(string name, IDictionary<string, object> parameters)
        {
            return this.Scope.ResolveNamed<T>(name, parameters.Select(kv => new NamedParameter(kv.Key, kv.Value)));
        }
    }
}